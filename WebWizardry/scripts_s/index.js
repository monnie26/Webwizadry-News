...
let getData = async () => {
  let res = await fetch(
    ` https://newsapi.org/v2/top-headlines?country=in&apiKey=0a26a7b584044bc5aedb6df42df1313e&pageSize=6`
  );
...
let getTopNews = async () => {
  let res = await fetch(
    `https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=0a26a7b584044bc5aedb6df42df1313e`
  );
  let data = await res.json();
  // console.log(data);
...
let getLatestNews = async () => {
  let res = await fetch(
    `https://newsapi.org/v2/everything?q=Apple&from=2022-08-24&sortBy=popularity&apiKey=0a26a7b584044bc5aedb6df42df1313e&pageSize=10`
  );
  let data = await res.json();
...
let getDataByCity = async (val) => {
  let res = await fetch(
    `https://newsapi.org/v2/everything?q=${val}&from=2022-08-24&sortBy=popularity&apiKey=0a26a7b584044bc5aedb6df42df1313e&pageSize=6`
  );
  let data = await res.json();
...
let getExtraNews = async () => {
  let res = await fetch(
    `https://newsapi.org/v2/everything?q=technology&from=2022-08-24&sortBy=relevancy&apiKey=0a26a7b584044bc5aedb6df42df1313e&pageSize=7`
  );
  let data = await res.json();
...
let getLifestyleNews = async () => {
  let res = await fetch(
    `https://newsapi.org/v2/everything?q=lifestyle&from=2022-08-24&sortBy=relevancy&apiKey=0a26a7b584044bc5aedb6df42df1313e&pageSize=7`
  );
  let data = await res.json();
  console.log(data);
